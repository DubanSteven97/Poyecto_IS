<?php	
	...
	$guardar=$conexion->query("insert into ingresar(nom_usu,ape_usu,id_usu,numero_documento,pas_usu,ema_usu,tel_usu)values ('','','$documento','$documento','$contrasena','$email',$telefono);");
