		...
		<section class="main">
			<div class="login">
						...
						<form action="php/login.php?cod_curso=<?php echo $_REQUEST['cod_curso'];?>&comprar=<?php echo $comprar;?>" method="post">					
							<input type="text" id="campo_1" name="usuario" required placeholder="Usuario" autocomplete="off" value="10245896">
							<input type="password" id="campo_1" name="contraseña"  required placeholder="Contraseña" autocomplete="off" value="IKfhzTPQ">
