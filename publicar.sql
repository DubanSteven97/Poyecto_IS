...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 20-05-2022 a las 06:51:26
...
(79, 34, 80, 95, 'Aprobado'),
(80, 34, 80, 96, 'Aprobado'),
(81, 34, 80, 97, 'Aprobado'),
(82, 34, 80, 98, 'Aprobado');
...
--
ALTER TABLE `ingresar`
  MODIFY `cod_usu` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=81;

--
-- AUTO_INCREMENT de la tabla `leccion`
--
ALTER TABLE `leccion`
  MODIFY `cod_leccion` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=101;
...
--
ALTER TABLE `progreso`
  MODIFY `id_progreso` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=83;
